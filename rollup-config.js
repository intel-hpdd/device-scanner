...
export default [
  {
    ...
    external: ['stream', 'child_process', 'buffer', 'net', 'path', '@iml/node-libzfs'],
    output: {
  ...
  },
  {
    ...
    external: ['stream', 'net', 'child_process', 'buffer', 'https', 'fs', 'path', 'url'],
    output: {
  ...
  },
  {
    ...
    external: ['stream', 'child_process', 'buffer', 'http', 'path', '@iml/node-libzfs'],
    treeshake: {
