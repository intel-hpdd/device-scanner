        ...
        |> Promise.bind (fun (commandResult, rollbackResult) ->
          ...
          match commandResult with
            ...
            | Error (e, _) ->
              ...
              myError == "{\"killed\":false,\"code\":127,\"signal\":null,\"cmd\":\"ssh -o LogLevel=error device-scanner.local 'ech \\\"goodbye\\\"'\"} - \"bash: ech: command not found\\n\""
  ...
  command {
    ...
    |> Promise.bind (fun (commandResult, rollbackResult) ->
      ...
      match commandResult with
        ...
        | Error (e, _) ->
          let myError = e |> errToString
          myError == "{\"killed\":false,\"code\":127,\"signal\":null,\"cmd\":\"ssh -o LogLevel=error device-scanner.local 'ech \\\"command1\\\"'\"} - \"bash: ech: command not found\\n\""
